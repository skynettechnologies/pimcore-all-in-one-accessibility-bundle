...
/**
 * @Route("/admin/adapimcore/config")
 */
class ConfigController extends \Pimcore\Controller\UserAwareController
{
    use JsonHelperTrait;

    public const CONFIG_NAME = 'plugin_adapimcore_config';
    ...
    private function buildItem($configuration): array
    {
        ...
        return [
            ...
            'type' => 'config',
            'iconCls' => 'plugin_pimcore_adapimcore_icon_' . $type,
            'expandable' => false,
            'leaf' => true,
            'adapter' => $type,
    ...
    public function addAction(Request $request): ?JsonResponse
    {
        ...
        try {
            ...
            $this->checkPermissionsHasOneOf(['plugin_adapimcore_admin', 'plugin_adapimcore_adapter_' . $type]);
    ...
    public function cloneAction(Request $request): ?JsonResponse
    {
        ...
        try {
            ...
            $this->checkPermissionsHasOneOf(['plugin_adapimcore_admin', 'plugin_adapimcore_adapter_' . $originalConfig->getType()]);
    ...
    public function getExplorerUrlAction(RouterInterface $routingService, Request $request): ?JsonResponse
    {
        ...
        $url = $routingService->generate('admin_pimcoreadapimcore_config', ['clientname' => $name]);
        if ($url) {
